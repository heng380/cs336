...
def run_get_batch(
    ...
    return tf.get_batch(dataset, batch_size, context_length, device)
    """
...
def run_gradient_clipping(parameters: Iterable[torch.nn.Parameter], max_l2_norm: float) -> None:
    ...
    """
    return tf.get_gradient_clipping(parameters, max_l2_norm)
    raise NotImplementedError
...
def run_get_lr_cosine_schedule(
    ...
    """
    return tf.get_lr_cosine_schedule(it, max_learning_rate, min_learning_rate, warmup_iters, cosine_cycle_iters)
    raise NotImplementedError
...
def run_save_checkpoint(
    ...
    return tf.save_checkpoint(model, optimizer, iteration, out)
    """
...
def run_load_checkpoint(
    ...
    return tf.load_checkpoint(src, model, optimizer)
    """
